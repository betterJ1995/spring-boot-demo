...
public class AesEncryptUtil {
     ...
     */
    public AesEncryptUtil(String token, String encodingAesKey, String clientId) throws XzhException {
    ...
    public String encryptXmlPassiveMsg(String replyMsg, String timeStamp,
        ...
        String signature = SHA1Util.getSHA1(token, timeStamp, nonce, encrypt);
    ...
    public String decryptXmlPassiveMsg(String msgSignature, String timeStamp,
        ...
        // 验证安全签名
        String signature = SHA1Util.getSHA1(token, timeStamp, nonce, decryptText);
