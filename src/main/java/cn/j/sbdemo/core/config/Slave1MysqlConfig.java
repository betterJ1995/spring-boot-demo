...
public class Slave1MysqlConfig {
    ...
    @Bean(name = "slave1SSF")
    public SqlSessionFactory slave1SqlSessionFactory(@Qualifier("slave1DataSource") DataSource dataSource, @Qualifier("defaultGlobalConfig") GlobalConfig globalConfig)
            throws Exception {
